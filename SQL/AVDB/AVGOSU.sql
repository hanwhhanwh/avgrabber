...
(
	...
	, `avgosu_board_no`		INT NOT NULL COMMENT 'AVGOSU etc 에서의 고유 번호'
	...
	, `cover_image_url`		VARCHAR(255) NULL COMMENT '표지 이미지 주소 정보 (\'/uploads/images\' 를 앞에 붙여야 함)' COLLATE 'utf8mb4_unicode_ci'
	, `thumbnail_url`		VARCHAR(255) NULL COMMENT '썸네일 이미지 주소 정보 (\'/uploads/images\' 를 앞에 붙여야 함)' COLLATE 'utf8mb4_unicode_ci'
	, `magnet_info`			VARBINARY(50) NULL DEFAULT NULL COMMENT '마그넷 주소 정보'
